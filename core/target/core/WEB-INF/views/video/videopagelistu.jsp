            ...
            <form action="/video/pagelistu" method="post" accept-charset="UTF-8">
                <c:choose>
                    <c:when test="${keywords == null}">
                        <input name="keywords" value="搜索本科视频"  class="search-bar"><input type="submit" value= "搜索" class="search-btn"/>
                    </c:when>
                    <c:otherwise>
                            ...
                            <div class="details">
                                <div class="video-inspiration">
                                    <a class="inspireVideo video-container">
                                        <i class="glyphicon glyphicon-play-circle"></i><img src="//${video.bitmap}" materialSrc="//${video.videoLink}">
                                    </a>
                                </div>
                            </div>
