...
<div class="container_box">
    ...
    <div id="applyForm">
        ...
        <div class="application_box application1" id="page01">
            <form id="form1">
                <h4 class="title">CIS中美常春藤科研项目申请</h4>
                <ul>
        ...
        <div class="application_box application2" id="page02">
            ...
            <div class="cis_word">
                ...
                <a href="http://focusedu.oss-cn-hangzhou.aliyuncs.com/activities/files/CIS%E4%B8%AD%E7%BE%8E%E5%B8%B8%E6%98%A5%E8%97%A4%E7%A7%91%E7%A0%94%E9%A1%B9%E7%9B%AE%E7%94%B3%E8%AF%B7%E8%A1%A8.docx">点击下载申请表>></a>
        ...
        <div class="application_box application4" id="page04">
            ...
            <p class="text"><i></i>看我看我独家绿色报名通道，支付<span style="font-weight:bold;font-size:22px;color:#f90;">1元抵200元学费</span></p>
            <div class="ewm_box">
                <p>
                    <img src="../../../images/wechatpay.jpg" style=" display:block;width: 168px;height: 168px; background-color: #018C9C;" />
                    <span>微信付款</span>
                </p>
                <p>
                    <img src="../../../images/alipay.jpg" style="display:block;width: 168px;height: 168px; background-color: #018C9C;" />
                    <span>支付宝付款</span>
                </p>
            </div>
            <div class="step_box">
