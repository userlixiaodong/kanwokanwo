...
<head>
    ...
    <link rel="stylesheet" href="/style/keruformlist.css">
</head>
    ...
    <div id="applyForm">
        ...
        <div class="application_box application2" id="page02">
            ...
            <div class="cis_word">
                ...
                <a href="http://focusedu.oss-cn-hangzhou.aliyuncs.com/activities/files/itoupform.docx">点击下载申请表>></a>
