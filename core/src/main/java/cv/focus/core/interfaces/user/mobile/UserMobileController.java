...
public class UserMobileController extends BaseController {
    ...
    public Result userLogin(
        ...
        Result<String> result = null;
        try {
            if ( userServiceFacade.checkLogin(email, userPwd)) {
            ...
            logger.error("UserMobileController.bind-submit()", e);
            result = newFaildResult(ResultMessages.SYSTEM_ERROR);
        }
        return result;
    }
    ...
    @RequestMapping("/checkEmailAvail")
    @ResponseBody
    public Result<String> checkEmailAvail(@RequestParam String email) {
        Result<String> result = null;
        try {
            ...
            logger.error("UserController.checkEmailAvail()", e);
            result = newFaildResult(ResultMessages.SYSTEM_ERROR);
        }
        return result;
    }
