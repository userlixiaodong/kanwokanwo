...
<head>
    ...
    <%--<link rel="stylesheet" href="/style/frame.css" type="text/css">--%>
    ...
    <div class="video-center" >
       <%-- <div>
            <form action="/video/pagelistu" method="post" accept-charset="UTF-8">
                 <c:choose>
                     <c:when test="${keywords == null}">
                         <input name="keywords" value="搜索大学"  class="search-bar"><input type="submit" value= "搜索" class="search-btn"/>
                     </c:when>
                     <c:otherwise>
        ...
        <ol class="highSchool-video-ul">
           <c:forEach var="University" items="${page.data}" >
                <li>
