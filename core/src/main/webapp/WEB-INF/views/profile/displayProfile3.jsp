...
<head>
    ...
    <style>
        .frame-top{
            background:url("/images/ch-frame-bg3.png") no-repeat top center;
            background-size:106% ;
        }
...
<div class="ch-frame">
    ...
    <div class="frame-top">
        ...
        <p><b>学校：</b>美国高中</p>
        <p><b>申请年级：</b>9升9</p>
        <p><b>TOEFL：</b>92；SSAT:1900+</p>
        <p><b>录取学校: </b><span class="ch-school">Trinity-Pawling School, Loyola School（NY）</span></p>
    </div>
    <div class="frame-bottom">
        <h5>简介</h5>
        <span class="ch-describe">
            通过视频，我们和远在美国的Steven开始了中英文的头脑风暴。Steven英文发音非常地道，爱好广泛，但是不能抓住重点，特质体现不够充分，无法给招生官留下深刻的印象。这一点在面试环节非常吃亏，针对这一点，我们根据Steven的时间表，安排了详细的面试辅导计划：第一轮进行美高常问问题的辅导，丰富话题内容，有重点有逻辑的进行回答；第二轮在选校确定后，针对每所学校进行专项匹配的辅导和练习；第三轮外教的Mock Interview，模拟面试环境，进行实战模拟训练；经过多轮辅导，我们帮助Steven清晰的确定了几项重要展示的方面：兴趣爱好--电影制作、高尔夫球、魔术、游戏编程、戏剧; 国际背景--出国前一直在德威国际学校就读，至今已在美国学习生活四年，多次参加美国和加拿大的夏令营等；Community Service上丰富的活动。

在文书上，经过焦点文书团队的讨论，Steven的文书主线是一个多才多艺，有想法，有个性的大男孩一直在在美国这个陌生的国度追寻自己的梦想-成为一名出色的好莱坞摄影导演。为了这个梦想，Steven一直在努力，假期多次前往纽约电影学院、温哥华的UBC大学学习电影制作有关的课程，学习并钻研编剧、导演、灯光、摄影和剪辑等课程。在美国寻梦的过程中，Steven是如何适应美国的文化习俗，如何慢慢克服地域、文化差异，融入到美国的教育和生活中。

面对Steven在领导力活动方面的欠缺，我们多次分析Steven的案例，Steven在学校GPA比较低这一现状是无法改变的，必须着手提升Steven在领导力活动上的空白。最终，我们启动了两个背景活动提供的方案，第一是在Steven高尔夫球上入手，因为Steven经过了3年的专业高尔夫球训练，可考虑创办一个高尔夫俱乐部，这个需要和学校进一步沟通可行性；第二个方案是在电影制作上安排相关活动，体现强化Steven的组织能力。两个方案同时进行，第一个方案因为学校处于放假阶段，回复审核周期比较长。最终，我们经过多次努力联系到了纽约电影学院曾经教授Steven的教授，教授对这位低龄的电影制作爱好者印象深刻，非常认可和喜爱Steven，了解到Steven的理想和正在申请美国中学的情况，表示了由衷地肯定和支持，并和我们分享了2016年暑假将在北京有一个为期两周的纽约电影学院关于电影制作方面的培训课程，并主动邀请Steven可以免费来上他的课程。得到这一消息，我们非常激动，对深化Steven电影制作的活动提升有很大帮助，经过和Steven父母的沟通，Steven目前在国际背景上非常丰富不需要再重复补充这个板块，最终我们说服了Steven和Steven父母放弃2016在美国上夏校的计划，继续深化在电影制作上的学习，我们也会帮助Steven争取在这次课程中，提升Steven的组织能力、协调能力。之后，我们辅导Steven给纽约电影学院的教授发送了一封感谢信，并主动请缨希望能够担任教授的助教，帮助教授做一些小力所能及的事情。教授非常感动于Steven对电影制作的热情，欣然接受了这位小帮手。课程期间，Steven一边上课，一边负责准备器材、进行翻译、组织学员活动等。培训课程顺利完成，教授非常开心能都再次遇到Steven，通过Steven的协助和安排，课程进行的异常顺利，教授和学员之间的沟通非常畅通，在结束时，教授给Steven写了一封热情的推荐信。

因为对纽约的喜爱，Steven主要申请位于纽约的学校。其中，Trinity-Pawling School是Steven一家的dream school，针对这一点，我们一方面安排了Steven一家12月初到三一中学的校园面试，另一方面我们指导Steven录制了自我介绍的音频，将Steven自己制作的高清影片，高尔夫比赛的现场视频、Steven魔术表演的视频等视频材料进行了剪辑、合成，最终上传至我们的看我看我平台，一个以文字、图片和视频为载体的电子简历生成。12月初，Steven一家开启了美国之行，在面试过程中，Steven也为招生官展示了自己在看我看我上的个人页面，招生官非常惊讶Steven的个人履历竟然如此丰富，学生和家长面试效果非常好！不负众望，Steven在3月10日如愿收到了Trinity-Pawling School的offer！
        </span>
    </div>
</div>
<%--中文介绍信息部分end--%>
