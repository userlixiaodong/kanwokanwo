...
<html>
<head>
        <title>看我看我 |活动提升|蔓藤—留学职业规划</title>
    <meta charset="UTF-8">
     <meta name="title" content="看我看我 | 留学 | 活动 | 蔓藤—留学职业规划">
    <meta name="keywords" content="看我看我 | 留学 | 活动 | 蔓藤—留学职业规划">
    <meta name="description" content="美国留学成本最高，少则四五十万多则上百万，然而毕业后“裸归”却成为一个普遍现象。按近三年的统计数据，没有任何职场经历只是完成海外学业的“裸归”群体，回国后平均月薪不到一万元。高投入却换不来高回报。">
...
利用蔓藤教育涵盖全美各行业的强大资深导师资源库，飞鹰计划保证每一位优秀的留学生获得美国专业实习经历，帮助学生开拓国际视野、增强专业素养、提升个人综合竞争力，为将来的美国求职铺平道路。
        ...
        <div class="businessParters">
            <p class="titles">合作企业</p>
            <ul class="partersList clearfix">
                <li><p><img style="display: block; width: 100%" src="/images/mantengS01.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS02.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS03.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS04.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS05.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS06.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS07.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS08.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS09.jpg" alt=""></p></li>
                <li><p><img style="display: block; width: 100%" src="/images/mantengS10.jpg" alt=""></p></li>
            </ul>
        </div>
