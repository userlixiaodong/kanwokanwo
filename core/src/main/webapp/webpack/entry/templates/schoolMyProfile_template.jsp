    ...
    <div class="clearfix">
        <div class="col-xs-12 text-center" id="myAvatarParent">
            <a class="md-trigger" data-modal="modal-avatar" href="javascript:void(0);">
                <@if(avatarUrl){@><img width="200" height="200" src="<@=avatarUrl.replace('focusedu.oss-cn-hangzhou.aliyuncs.com','img-cdn.kanwokanwo.com')@>@1e_1c_0o_0l_200h_200w_80q.src" id="avatarSrc">
                <@}else{@><img width="200" height="200" src="/images/defaultAdmissionAvatar.jpg" id="avatarSrc"><@}@>
            </a>
        </div>
    </div>
    ...
    <ul class="col-xs-12 icon-list">
        <li>
            ...
            <a class="md-trigger modifyBiography" href="javascript:void(0);">
                <p><span>
                <@if(currentSchool){@><@=currentSchool@><@}else{@>College<@}@>
            </span></p>
            </a>
        </li>
        <li>
        ...
        <li>
            ...
            <a class="md-trigger modifyBiography" href="javascript:void(0);">
                <p><span>
            <@if(position){@><@=position@><@}else{@>Job Title/Role<@}@>
            </span></p>
            </a>
        </li>
        <li>
            ...
            <a class="md-trigger modifyBiography" href="javascript:void(0);">
                <p><span>
            <@if(webSite){@><@=webSite@><@}else{@>WebSite<@}@>
            </span></p>
            </a>
        </li>
    </ul>
    <a href="javascript:;" class="my-links md-trigger" data-modal="modal-addMyLinks" id="myLinksBtn">My Links</a>
</script>
    ...
    <div class="md-effect-1 reveal-modal md-show edit-user-info">
        <div class="md-content">
            ...
            <form>
                ...
                <input type="button" id="updateBioBtn" value="Save" class="reveal-button">
            </form>
            <button class="md-close"><i class="glyphicon glyphicon-remove"></i></button>
        </div>
    </div>
