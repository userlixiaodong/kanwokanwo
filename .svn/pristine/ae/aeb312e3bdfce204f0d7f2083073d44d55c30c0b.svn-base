...
<script type="text/javascript" src="http://test.static.kanwokanwo.com/schoolMyProfile-bundle.js"></script>
...
<%@ include file="/webpack/entry/templates/schoolMyProfile_template.jsp" %>
<script>
</script>
