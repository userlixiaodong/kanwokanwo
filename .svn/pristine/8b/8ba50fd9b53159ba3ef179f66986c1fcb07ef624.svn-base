...
<div class="container">
    <div class="searchBar">
        <form class="searchForm" role="search" action="${staticPath}/admission/profile/searchList" id="formid">
            <div class="searchGroup">
                ...
                <input type="submit" id="btn1" class="searchButton" value="搜索">
            </div>
        </form>
    ...
    <form class="term-filter" id="form" action="/admission/profile/search" name="myform" >
    <div class="conditions">
        <div class="term">
                <ul>
                    <li class="screen">
                        <label>学校类型：</label>
                        <input type="radio" name="schoolLevel" value="1" <c:if test="${schoolLevel==1}">checked="checked"</c:if> id="schoolLevel1" class="schoolLevel">本科
                        <input type="radio" name="schoolLevel" value="2" <c:if test="${schoolLevel==2}">checked="checked"</c:if> id="schoolLevel2" class="schoolLevel">高中
                        <input type="radio" name="schoolLevel" value="3" <c:if test="${schoolLevel==3}">checked="checked"</c:if> id="schoolLevel3" class="schoolLevel">初中
                    </li>
