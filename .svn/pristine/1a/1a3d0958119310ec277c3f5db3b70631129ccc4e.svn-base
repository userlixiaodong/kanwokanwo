...
require("jquery_rebox");
window._ = require("underscore");
window.Backbone = require("backbone");
window.Backbone.$ = require('jquery');
window.Marionette = window.Mn = require('marionette');
limits = 500;
...
App.RemarkListView = Marionette.ItemView.extend({
    ...
    onRender: function () {
        ...
        $(".friend-impression-list li").each(function (index, element) {
            var colorCode = that.randomColor;
...
//------------------Activity Models-----------------------------------------
App.activityTags = ["Arts", "Sports", "Services", "Culture", "Debate/Speech", "Communication", "Science", "Language", "Religion", "Working Exp", "Others", "All"];
...
window.limitWordsCounts = function (result) {
