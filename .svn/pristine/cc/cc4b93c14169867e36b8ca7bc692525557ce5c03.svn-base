...
public class SpecializationServiceImpl implements SpecializationService {
    ...
    public void itemSaved(SavedEntity savedEntity){
        specializationRepositoryHibernateImpl.itemSaved(savedEntity);
    }

    @Override
    public void updateCollect(ItemEntity item){
        specializationRepositoryHibernateImpl.updateCollect(item);
    }

    @Override
    public String checkCollect(Integer userId, Integer itemId){
        return specializationRepositoryHibernateImpl.checkCollect(userId, itemId);
    }

    @Override
    public WebPage collectList(Integer userId,WebPage page) {
        return specializationRepositoryHibernateImpl.collectList(userId,page);
    }

    @Override
    public SavedEntity findCollection(Integer userId, Integer itemId){
        return specializationRepositoryHibernateImpl.findCollection(userId,itemId);
    }
