...
<script type="text/template" id="material-edit-template">
    ...
    <@}else if(type == 'DOC'){@>
    <div class="edit-hover">
        <a href="<@=materialSrc@>" target="_blank" class="edit-document-item text-center"><i class="glyphicon glyphicon-list-alt"></i>
...
<script src="/js/mn_test/myProfile.js?version=201605121633"></script>
