...
showPages.prototype.createHtml = function(mode){
	...
	if (prevPage < 1) {
		...
		strHtml += '<li title="上一页" class="disabled"><a href="javascript:;">上一页</a></li>';
	} else {
		//strHtml += '<li title="首页"><a href="javascript:' + this.name + '.toPage(1);">首页</a></li>';
		strHtml += '<li title="上一页"><a href="javascript:' + this.name + '.toPage(' + prevPage + ');">上一页</a></li>';
	}
	...
	if (nextPage > this.pageCount) {
		strHtml += '<li class="disabled" title="下一页"><a href="javascript:;">下一页</a></li>';
		//strHtml += '<li class="disabled" title="尾页"><a href="javascript:;">尾页</a></li>';
	} else {
		strHtml += '<li title="'+ nextPage + '"><a href="javascript:' + this.name + '.toPage(' + nextPage + ');">下一页</a></li>';
