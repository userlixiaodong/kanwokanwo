            ...
            <div class="gis_banner_btn">
                <c:choose>
                    <c:when test="${sessionScope.loginUser == null}">
                        <a href="javascript:trackOutboundLink('', 'index_topRightSignUp');" class="registerBtn register md-trigger" data-modal="modal-selectType" id="registerBtn1">免费注册</a>
                    </c:when>
                    <c:otherwise>
                        <a href="/${sessionScope.loginUser.publicUri}" class="registerBtn" id="registerBtn2">查看你的简历</a>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
                    ...
                    <ul class="part2-students">
                        <li>
                            <div class="video-introduce">
                                <p>SHINING ZHAO<a href="/shiningzhao" class="hisVideo">他的视频简历</a></p>
                                <p>牛津大学&nbsp;&nbsp;&nbsp;&nbsp;帝国理工大学&nbsp;&nbsp;&nbsp;&nbsp;佐治亚理工学院</p>
                            </div>
                        </li>
                        <li>
                            <div class="video-introduce">
                                <p>XINYUYAO<a href="/xinyuyao" class="hisVideo">她的视频简历</a></p>
                                <p>波士顿学院&nbsp;&nbsp;&nbsp;&nbsp;罗彻斯特大学&nbsp;&nbsp;&nbsp;&nbsp;凯斯西储大学</p>
                            </div>
                        </li>
                        <li>
                            <div class="video-introduce">
                                <p>CHENG CHI<a href="/chengchi" class="hisVideo">他的视频简历</a></p>
                    ...
                    <div class="part5-rightInner">
                        <ul class="part5-list">
                            ...
                            <li>
                                <c:choose>
                                    <c:when test="${sessionScope.loginUser == null}">
                                        <a href="javascript:trackOutboundLink('', 'index_topRightSignUp');" class=" register md-trigger" data-modal="modal-selectType" id="registerBtn3">建立自己的视频简历</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="/${sessionScope.loginUser.publicUri}" id="registerBtn4">建立自己的视频简历</a>
                                    </c:otherwise>
                                </c:choose>
                            </li>
                        </ul>
