...
<head>
    ...
    <link rel="stylesheet" href="/style/mantengformlist.css">
</head>
...
<div class="container_box">
    ...
    <div id="applyForm">
        ...
        <div class="application_box application2" id="page02">
            ...
            <p class="text"><i></i>请下载下方申请表格，填写完整以便对您做出更准确的评估</p>
            <div class="cis_word">
                <img src="/images/wordIcon-1.png" alt="" />
                <a href="http://focusedu.oss-cn-hangzhou.aliyuncs.com/activities/files/manteng.docx">点击下载报名表>></a>
        ...
        <div class="application_box application3" id="page03">
            <form id="fileForm" name="form2" enctype="multipart/form-data">
                ...
                <div class="cis_word">
                    ...
                    <a href="javascript:void(0);" id="uploadApplyTable">点击上传报名表>></a>
